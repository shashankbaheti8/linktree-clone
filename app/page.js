...
export default function Home() {
  ...
  return (
    <main>
        ...
        <div className="flex justify-center flex-col ml-[10vw] gap-3">
          ...
          <div className="input flex gap-2">
            <input
              ...
              className="px-2 py-2 bg-white focus:outline-green-800 rounded-md"
              type="text"
              placeholder="Enter your Handle"
            />
            <button
              onClick={() => createTree()}
              className="bg-pink-300 rounded-full px-4 py-4 font-semibold cursor-pointer"
            >
              Claim your linktree
            </button>
          </div>
      ...
      <section className="bg-pink-300 min-h-screen"></section>
    </main>
  );
}
