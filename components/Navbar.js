...
const Navbar = () => {
  ...
  return (
    <>
      {showNavbar && (
        <nav className="flex justify-between bg-white w-[80vw] fixed top-8 right-[10vw] rounded-full p-4">
          ...
          <div className="flex gap-3">
            <button className="bg-gray-200 p-4 rounded-xl cursor-pointer">
              Log in
            </button>
            <button className="text-white bg-[#1E2330] p-4 rounded-full cursor-pointer">
              Signup free
            </button>
          </div>
        </nav>
